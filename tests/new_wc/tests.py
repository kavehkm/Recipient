...
class TestWC(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.wc_product = new_wc.get(api, self.endpoint)
        self.product_ids = []
        self.products_data = [
    ...
    def test_unauthorized_request(self):
        ...
        wc_product = new_wc.get(api, 'products')
        with self.assertRaises(Exception) as cm:
            wc_product.all()
        self.assertIsInstance(cm.exception, new_wc.UnauthorizedError)
    ...
    def test_get_with_invalid_id(self):
        ...
        self.assertIsInstance(cm.exception, new_wc.NotFoundError)
